#!/bin/bash
# Build essential lib c/c++
sudo apt-get -y install build-essential clang clang-format
# VPN
...
sudo apt-get -y install libboost-all-dev flex unixodbc-dev mysql-client libmysqlclient-dev libevent-dev bison autoconf ssh sshfs samba libpcre++-dev libcurl3 libc6-dbg libnspr4 libnspr4-0d libnss3-1d
